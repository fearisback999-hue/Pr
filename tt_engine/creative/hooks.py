...
_TEMPLATES = {
    "curiosity": [
        ...
        "What the {name} does at 0:07 is wild",
        "I tested the {name} so you don't have to",
        "The {name} everyone keeps gatekeeping",
        "Things I wish I knew before the {name}",
        "Rating the {name} my followers made me buy",
        "The {name} trend explained in 20 seconds",
        "So THIS is why the {name} sold out",
        "Answering your top {name} questions",
    ],
    "problem": [
        ...
        "Me before the {name}: {pain} daily",
        "Your {pain} isn't normal. Watch",
        "The real reason {pain} keeps happening",
        "{pain} had me until I tried this",
        "Nobody talks about {pain}. Let's fix it",
        "3 signs {pain} is costing you",
        "The {name} vs my {pain}: round one",
        "How I finally stopped {pain}",
    ],
    "shock": [
        ...
        "The {name} just did something illegal-feeling",
        "Filming this {name} demo with zero cuts",
        "My jaw is on the floor. The {name}",
        "The {name} at full power is unreal",
        "Did the {name} just do that live?",
        "No edits. Just the {name}. Watch",
        "The {name} result nobody warned me about",
        "Speechless. The {name}. That's the video",
    ],
    "transformation": [
        ...
        "Day 1 vs day 7 with the {name}",
        "The {name} glow-up nobody expected",
        "One week with the {name}. Look",
        "What changed after I got the {name}",
        "My routine before vs after the {name}",
        "The {name} upgrade you can see",
        "Proof the {name} actually works",
        "Small purchase. Big difference. The {name}",
    ],
}
